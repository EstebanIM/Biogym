                ...
                <main className="flex-1 p-6 overflow-y-auto">
                    <div className="flex flex-col items-center p-6 bg-gray-100 min-h-screen">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-5xl">
                            ...
                            <Link to="/bugs" className="hover:shadow-lg transition">
                                <Card className="bg-white rounded-lg shadow-md flex flex-col items-center text-center p-6 transform hover:scale-105 transition-transform duration-300">
                                    <CardHeader className="flex flex-col items-center mb-4">
                                        <div className="bg-gray-800 rounded-full p-4 mb-3">
                                            <Bug className="h-12 w-12 text-red-500" />
                                        </div>
                                        <CardTitle className="text-lg font-semibold text-gray-700">Bugs</CardTitle>
                                        <CardDescription className="text-sm text-gray-500 mt-2">
                                            Reporta y gestiona los errores en el sistema.
                                        </CardDescription>
                                    </CardHeader>
                                </Card>
                            </Link>
